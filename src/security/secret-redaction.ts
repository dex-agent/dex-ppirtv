 ...
 * - The pattern is intentionally broad; false positives (redacting a
 *   non-secret that looks like one) are acceptable for a PPIRTV runtime
 *   that never needs to surface raw secrets.
 */
